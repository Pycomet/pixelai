...
export const LoginComponent = () => {
    ...
    const onSubmit = async (data: LoginFormData) => {
        ...
        if (user) {
            ...
            message("Failed to sign in. Please check your credentials and try again.", "error");
        }
    };
            ...
            >
                ...
                {() => (
                    ...
                    <ModalBody>
                        ...
                        <Button isLoading={loading} className={`${button({ hideOnMobile: true })} uppercase justify-center w-auto px-[5em] mx-auto`} type="submit">
                            Login
                        </Button>
                        <hr className="mx-20" />
                        <p className="mt-2 font-normal text-xs text-center">Or Sign In Using</p>
                        <div className="flex flex-row justify-center gap-2">
                            <GoogleIcon className="cursor-pointer" onClick={() => signInWithGoogle()}/>
